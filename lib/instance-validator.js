 ...
 * @return {Promise}
 */
InstanceValidator.prototype.hookValidate = function(options) {
  var self = this;
  return self.modelInstance.Model.runHooks('beforeValidate', self.modelInstance, options).then(function() {
    ...
    return self.modelInstance.Model.runHooks('afterValidate', self.modelInstance, options);
