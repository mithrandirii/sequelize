...
InstanceValidator.prototype._invokeBuiltinValidator = Promise.method(function(value, test, validatorType, field) {
  ...
  if (this.modelInstance && this.modelInstance.__options && this.modelInstance.__options.name && this.modelInstance.__options.name.singular) {
    validatorArgs.push(this.modelInstance.__options.name.singular);
  }
