    ...
    */
    ...
    selectQuery: function(tableName, options, model) {
      ...
      var table = null
        ...
        , mainJoinQueries = []
        // We'll use a subquery if we have hasMany associations and a limit and a filtered/required association and non raw query
        , subQuery = limit && !options.raw && (options.hasIncludeWhere || options.hasIncludeRequired || options.hasMultiAssociation)
        , subQueryItems = []
