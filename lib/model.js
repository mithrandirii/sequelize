...
module.exports = (function() {
  ...
  Model.prototype.init = function(modelManager) {
    ...
    if (this.options.timestampsReadOnly === true || this.options.timestampsReadOnly === undefined) {
  ...
  */
  ...
  Model.prototype.findAndCount = function(findOptions, queryOptions) {
    ...
    if (countOptions.include) {
      ...
      if (queryOptions.keepNeededOnly === undefined || queryOptions.keepNeededOnly === true) {
