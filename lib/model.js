  ...
  Model.prototype.findOrInitialize = Model.prototype.findOrBuild = function(params, defaults, options) {
    ...
    return self.find({
      ...
      if (instance === null) {
        ...
        return build.hookValidate({skip: Object.keys(params)}, options).then(function() {
    ...
    return Promise.try(function() {
      ...
      if (options.validate) {
        ...
        return Promise.map(daos, function(dao) {
          ...
          return dao[fn]({skip: skippedFields}, options).then(function(err) {
            if (!!err) {
    ...
    return Promise.try(function() {
      ...
      if (options.individualHooks) {
        return self.all({where: where}, {transaction: options.transaction}).map(function(dao) {
          return self.runHooks('beforeDestroy', dao, options).spread(function(_dao) {
            return _dao || dao;
          });
        }).then(function(_daos) {
          daos = _daos;
  ...
  Model.prototype.update = function(attrValueHash, where, options) {
    ...
    return Promise.try(function() {
      ...
      if (options.validate) {
        ...
        return build.hookValidate({skip: skippedFields}, options).then(function(attributes) {
      ...
      if (options.individualHooks) {
        return self.all({where: where}, {transaction: options.transaction}).then(function(_daos) {
          ...
          return Promise.map(daos, function(dao) {
            ...
            return self.runHooks('beforeUpdate', dao, options).spread(function(_dao) {
              dao = _dao || dao;
      ...
      if (options.individualHooks) {
        return Promise.map(daos, function(dao) {
          return self.runHooks('afterUpdate', dao, options).spread(function(_dao) {
            return _dao || dao;
          });
        }).then(function(_daos) {
          result[1] = daos = _daos;
