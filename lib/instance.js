...
module.exports = (function() {
  ...
  Instance.prototype.save = function(fieldsOrOptions, options) {
    ...
    return Promise.try(function() {
      // Validate
      if (options.hooks) {
        return self.hookValidate({skip: _.difference(Object.keys(self.rawAttributes), options.fields)}, options);
      }
    }).then(function() {
  ...
  */
  ...
  Instance.prototype.hookValidate = function(object, options) {
    var validator = new InstanceValidator(this, object);

    return validator.hookValidate(options);
  };
  ...
  Instance.prototype.destroy = function(options) {
    ...
    return Promise.try(function() {
      ...
      if (self.Model._timestampAttributes.deletedAt && options.force === false) {
        ...
        hookOptionOnUpdate = options.hooks;
        options.hooks = false;
      ...
      // Run after hook
      if (options.hooks || hookOptionOnUpdate) {
