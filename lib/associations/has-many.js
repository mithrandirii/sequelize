...
module.exports = (function() {
  ...
  HasMany.prototype.injectAttributes = function() {
    ...
    if (!this.target.deferedAttributeRefresh) {
      this.target.refreshAttributes();
    } else {
      this.target.deferedAttributesToRefresh = true;
    }
    if (!this.source.deferedAttributeRefresh) {
      this.source.refreshAttributes();
    } else {
      this.source.deferedAttributesToRefresh = true;
    }
